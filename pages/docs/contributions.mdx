...
**Các cấu hình khác trên Card:**

- title
- icon (`ArrowLeft`, `ArrowLeftShort`, `ArrowRight`, `ArrowRightShort`,
  `CaretDown`, `CaretUp`, `Chat`, `Check`, `Facebook`, `GitHub`, `Linkedin`,
  `ReactIcon`, `Twitter`, `TableLayout`, `Server`, `SwatchBook`,
  `Folder`,`FileCode`)
- href
...
**Các cấu hình khác trên Card Group:**

`cols` bên trong `CardGroup` mặc định là 2, bạn có thể tăng nó lên thành 3
hoặc 4.
