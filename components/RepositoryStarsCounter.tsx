...
export default function RepositoryStarsCounter() {
  ...
  return (
    <Link
      href={`https://github.com/${siteConfig.githubRepoFullName}`}
      className="group mt-4 rounded-lg border border-transparent overflow-hidden bg-origin-border bg-gradient-to-r from-vnodesign-500 to-sky-500 text-gray-500 dark:text-gray-400 w-full"
      title="Explore the Repository"
    >
      <div className="p-4 dark:bg-[#111111] bg-white">
        <animated.p className="inline-block text-xl bg-gradient-to-r from-vnodesign-500 to-sky-500 bg-clip-text text-transparent tabular-nums font-semibold">
