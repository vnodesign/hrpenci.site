    ...
    <div className="relative flex items-center justify-between p-2 text-xl group">
      <span
        className={cn(
          ...
          'after:h-[24px] after:w-[44px] after:rounded-full dark:after:bg-[#333333] after:shadow-sm after:duration-300 after:border dark:after:border-[#333333] after:border-[#666666]/100 after:bg-gradient-to-b after:from-[#3286F1] after:to-[#C33AC3] after:opacity-20 dark:after:opacity-100 dark:after:bg-none',
      ...
      {site && (
        <span
          className={cn(
            'z-50 absolute p-1 text-sm flex justify-between text-center w-[100px] text-slate-700 dark:text-slate-300',
            { 'text-slate-900 dark:text-white': site }
          )}
        >
