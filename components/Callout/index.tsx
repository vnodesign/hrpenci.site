...
function CalloutTemplate({
  ...
  return (
    <div className={cn('px-5 py-4 my-4 overflow-hidden rounded-xl', className)}>
      <div className="flex items-start space-x-3">
        <div className="w-4 my-auto">{icon}</div>
        <div
          className={cn('flex-1 text-sm overflow-x-auto', childrenClassName)}
        >
          {children}
        </div>
      </div>
...
function Info({ children }: CalloutContent) {
  return (
    <CalloutTemplate
      icon={
        <svg
          ...
          className="flex-none size-5 text-zinc-400 dark:text-zinc-300"
          aria-label="Info"
        >
...
function Warning({ children }: CalloutContent) {
  return (
    <CalloutTemplate
      icon={
        <svg
          className="flex-none size-5 text-amber-400 dark:text-amber-300/80"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
...
function Note({ children }: CalloutContent) {
  return (
    <CalloutTemplate
      icon={
        <svg
          ...
          fill="currentColor"
          xmlns="http://www.w3.org/2000/svg"
          className="size-4 text-vnodesign-500"
          aria-label="Note"
        >
          <path
            fillRule="evenodd"
...
function Tip({ children }: CalloutContent) {
  return (
    <CalloutTemplate
      icon={
        <svg
...
function Check({ children }: CalloutContent) {
  return (
    <CalloutTemplate
      icon={
        <svg
